      ...
      >
        ...
        <div className="max-w-3/4 mx-auto w-full p-10 flex-1">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-300 h-[900px] flex flex-col">
                            ...
                            <div className="bg-blue-50 p-3 rounded">
                              ...
                              <div className="mt-1">
                                ...
                                <div className="text-sm text-gray-600">
                                  Available:{" "}
                                  {formatCurrency(
                                    message.content.fundSource.available
                                  )}
                                  of{" "}
                                  {formatCurrency(
                                    message.content.fundSource.amount
                                  )}
                                </div>
                              </div>
                            </div>
                            ...
                            message.content.citations.length > 0 && (
                              <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                                <strong className="text-red-800 text-sm">
                                  Relevant Grant Agreement Restrictions:
                                </strong>
                          ...
                          {message.content.showChangeAgreementButton && (
                            <div className="mt-4">
                              <button
                                ...
                                onClick={() =>
                                  alert(
                                    "Request to change agreement submitted!"
                                  )
                                }
                              >
